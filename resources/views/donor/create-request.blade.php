        ...
        <form method="POST" action="{{ route('donor.requests.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="units_required" class="form-control" value="{{ old('units_required', 1) }}" min="1" max="20" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="mt-4 d-flex gap-2">
                ...
                <a href="{{ route('donor.requests') }}" class="btn btn-outline-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
